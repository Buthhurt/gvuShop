            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" method="post" action="UserServlet">
                        ...
                        <div class="form-group">
                            ...
                            <div class="cols-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="login" id="login" placeholder="Введите Login" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group ">
                            <a type="button" class="btn btn-primary btn-dark btn-block login-button" href="index.jsp">Назад</a>
                        </div>
